...
export type FindAdQuery = { __typename?: 'Query', findAd?: { __typename?: 'Ad', title?: string | null, picture: string, price?: number | null, id?: string | null } | null };
...
export type FindAdForUpdateQuery = { __typename?: 'Query', findAd?: { __typename?: 'Ad', title?: string | null, description?: string | null, price?: number | null, picture: string, location?: string | null, category?: { __typename?: 'Category', id: string } | null, tags?: Array<{ __typename?: 'Tag', label: string, id: string }> | null } | null };
...
export type SearchAdQuery = { __typename?: 'Query', searchAd?: Array<{ __typename?: 'SearchAdsResult', categoryId: string, categoryTitle: string, ads?: Array<{ __typename?: 'Ad', title?: string | null, id?: string | null }> | null } | null> | null };

export type GetInfosForCheckoutQueryVariables = Exact<{
  ids: Array<Scalars['ID']['input']> | Scalars['ID']['input'];
}>;


export type GetInfosForCheckoutQuery = { __typename?: 'Query', getInfosForCheckout?: Array<{ __typename?: 'InfosForCheckout', id: string, title: string, description?: string | null, picture?: string | null, price: number }> | null };
...
export type RegisterMutation = { __typename?: 'Mutation', register?: { __typename?: 'UserWithoutPassword', id: string, email: string } | null };
...
export type LoginQuery = { __typename?: 'Query', login: { __typename?: 'Message', success?: boolean | null, message?: string | null } };

export type LogoutQueryVariables = Exact<{ [key: string]: never; }>;


export type LogoutQuery = { __typename?: 'Query', logout: { __typename?: 'Message', success?: boolean | null, message?: string | null } };

export type CheckTokenQueryVariables = Exact<{ [key: string]: never; }>;


export type CheckTokenQuery = { __typename?: 'Query', checkToken?: { __typename?: 'CheckToken', email?: string | null } | null };
...
export const SearchAdDocument = gql`
...
/**
 * __useSearchAdQuery__
 *
 * To run a query within a React component, call `useSearchAdQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchAdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchAdQuery({
 *   variables: {
 *      search: // value for 'search'
 *   },
 * });
 */
export function useSearchAdQuery(baseOptions: Apollo.QueryHookOptions<SearchAdQuery, SearchAdQueryVariables> & ({ variables: SearchAdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SearchAdQuery, SearchAdQueryVariables>(SearchAdDocument, options);
      }
export function useSearchAdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchAdQuery, SearchAdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchAdQuery, SearchAdQueryVariables>(SearchAdDocument, options);
        }
export function useSearchAdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<SearchAdQuery, SearchAdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<SearchAdQuery, SearchAdQueryVariables>(SearchAdDocument, options);
        }
export type SearchAdQueryHookResult = ReturnType<typeof useSearchAdQuery>;
export type SearchAdLazyQueryHookResult = ReturnType<typeof useSearchAdLazyQuery>;
export type SearchAdSuspenseQueryHookResult = ReturnType<typeof useSearchAdSuspenseQuery>;
export type SearchAdQueryResult = Apollo.QueryResult<SearchAdQuery, SearchAdQueryVariables>;
export const GetInfosForCheckoutDocument = gql`
...
/**
 * __useGetInfosForCheckoutQuery__
 *
 * To run a query within a React component, call `useGetInfosForCheckoutQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetInfosForCheckoutQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetInfosForCheckoutQuery({
 *   variables: {
 *      ids: // value for 'ids'
 *   },
 * });
 */
export function useGetInfosForCheckoutQuery(baseOptions: Apollo.QueryHookOptions<GetInfosForCheckoutQuery, GetInfosForCheckoutQueryVariables> & ({ variables: GetInfosForCheckoutQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetInfosForCheckoutQuery, GetInfosForCheckoutQueryVariables>(GetInfosForCheckoutDocument, options);
      }
export function useGetInfosForCheckoutLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetInfosForCheckoutQuery, GetInfosForCheckoutQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetInfosForCheckoutQuery, GetInfosForCheckoutQueryVariables>(GetInfosForCheckoutDocument, options);
        }
export function useGetInfosForCheckoutSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetInfosForCheckoutQuery, GetInfosForCheckoutQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetInfosForCheckoutQuery, GetInfosForCheckoutQueryVariables>(GetInfosForCheckoutDocument, options);
        }
export type GetInfosForCheckoutQueryHookResult = ReturnType<typeof useGetInfosForCheckoutQuery>;
export type GetInfosForCheckoutLazyQueryHookResult = ReturnType<typeof useGetInfosForCheckoutLazyQuery>;
export type GetInfosForCheckoutSuspenseQueryHookResult = ReturnType<typeof useGetInfosForCheckoutSuspenseQuery>;
export type GetInfosForCheckoutQueryResult = Apollo.QueryResult<GetInfosForCheckoutQuery, GetInfosForCheckoutQueryVariables>;
